"""WGF / Langevin-sampling DRO baseline."""
...
from utils.samplers import wgf_sampler
...
def train_algorithm_wgf(
    cfg: TrainConfig, device: torch.device
) -> Tuple[TrainState, Dict[str, Any]]:
    return train_algorithm_generic_adv("wgf", "WGF", cfg, device, train_step_wgf)
