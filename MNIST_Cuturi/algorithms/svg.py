...
from utils.samplers import svg_sampler
...
def train_step_svg(
    ...
    adv_x = svg_sampler(
        ...
        cfg.particle_inner_lr, cfg.svg_adagrad_hist_decay,
        clamp=(0.0, 1.0),
    )
...
def train_algorithm_svg(
    cfg: TrainConfig, device: torch.device
) -> Tuple[TrainState, Dict[str, Any]]:
    return train_algorithm_generic_adv("svg", "SVG", cfg, device, train_step_svg)
